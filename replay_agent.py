...
class DQNAgent:
    ...
    def save_model(self):
        ...
        self.saver.save(sess=self.session, save_path="/Users/karanmaheshwari/PycharmProjects/AppliedMLForGames/models/", global_step=self.step)

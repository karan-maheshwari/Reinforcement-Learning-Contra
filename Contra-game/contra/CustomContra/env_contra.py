"""An OpenAI Gym interface to the NES game <TODO: CustomContra>"""
import numpy as np
from nes_py import NESEnv
import time
from contra.CustomContra.ROMs.decode_target import decode_target
from contra.CustomContra.ROMs.rom_path import rom_path
...
class ContraEnv(NESEnv):
    ...
    def __init__(self, lost_levels=False, target=None):
        """
        Initialize a new CustomContra environment.
